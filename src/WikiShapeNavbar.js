      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
          <NavDropdown title="Entity" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.wikidataOutgoingRoute)}>
              Info about entity (outgoing arcs)
            </NavDropdown.Item>
          </NavDropdown>
          <NavDropdown title="Schema" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.wikidataSchemaInfoRoute)}>
              Info about entity schema
            </NavDropdown.Item>
          ...
          <NavDropdown title="Query" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.wikidataQueryRoute)}>
              Query SPARQL endpoint
            </NavDropdown.Item>
          </NavDropdown>
          <NavDropdown title="Validate" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.wikidataValidateDerefRoute)}>
              Validate an entity (simple)
            </NavDropdown.Item>
            <NavDropdown.Item href={mkHash(API.wikidataValidateRoute)}>
              Validate an entity (SPARQL)
            </NavDropdown.Item>
            <NavDropdown.Item href={mkHash(API.wikidataValidateSPARQLRoute)}>
              Validate entities obtained from SPARQL queries (SPARQL)
            </NavDropdown.Item>
          </NavDropdown>
          <NavDropdown title="Extract" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.wikidataExtractRoute)}>
              Extract schema from entity (simple)
            </NavDropdown.Item>
            <NavDropdown.Item href={mkHash(API.wikidataSheXerRoute)}>
        ...
        <Nav>
          <NavDropdown title="Examples" id="basic-nav-dropdown">
            <NavDropdown.Item href="/wikidataOutgoing?endpoint=https%3A%2F%2Fquery.wikidata.org%2Fsparql&entities=%5B%7B%22label%22%3A%22Douglas%20Adams%22%2C%22id%22%3A%22Q42%22%2C%22uri%22%3A%22http%3A%2F%2Fwww.wikidata.org%2Fentity%2FQ42%22%2C%22descr%22%3A%22English%20writer%20and%20humorist%22%7D%5D">
              Show entity (Q42)
            </NavDropdown.Item>
            {/*<NavDropdown.Item href='/#/wikidataSchemaInfo?id=E42&lang=en'>Show entity schema (E42)</NavDropdown.Item>*/}
            <NavDropdown.Item href="/wikidataSchemaVisual?id=E42&lang=en">
              Visualize entity schema (E42)
            </NavDropdown.Item>
          ...
          <NavDropdown title="Settings" id="basic-nav-dropdown">
            <NavDropdown.Item href={mkHash(API.changeWikibaseURLRoute)}>
          ...
          <NavDropdown title="Help" id="basic-nav-dropdown" className="mr-sm-2">
            ...
            <NavDropdown.Item href={mkHash(API.aboutRoute)}>
              About
            </NavDropdown.Item>
          </NavDropdown>
        </Nav>
