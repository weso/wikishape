     ...
     return (
       <Container>
         <h1>About Wikishape</h1>
           ...
           <p>This is a fork of <a href="http://rdfshape.weso.es">rdfshape.weso.es</a> customized for <a href="http://wikidata.org">Wikidata</a></p>
           <p>Paper describing RDFShape: <a href="http://ceur-ws.org/Vol-2180/paper-35.pdf">RDFShape: An RDF playground based on Shapes</a>,
            ...
            <li>Version {process.env.REACT_APP_VERSION} [{process.env.NODE_ENV}]</li>
                <li>Server host: <a href={process.env.REACT_APP_RDFSHAPE_HOST}>{process.env.REACT_APP_RDFSHAPE_HOST}</a></li>
                   ...
                   <li>Source code:
                       <ul>
                           <li><a href="https://github.com/weso/wikishape">Client</a></li>
                           <li><a href="https://github.com/weso/rdfshape-client">Client</a></li>
                           <li><a href="https://github.com/weso/rdfshape">Server</a></li>
                           <li><a href="https://github.com/weso/shaclex">validation libraries</a></li>
                       </ul>
                   </li>
