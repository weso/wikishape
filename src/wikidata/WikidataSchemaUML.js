...
import WikidataSchemaUMLResult from "./WikidataSchemaUMLResult";
import shumlex from "shumlex";

function WikidataSchemaUML(props) {
  ...
  const fetchSchemaEntity = async (e) => {
    ...
    try {
	  ...
	  let xmi = shumlex.shExToXMI(schemaResult.data);
      ...
      setResult(xmi);
      setPermalink(
        mkPermalinkLong(API.wikidataSchemaUMLRoute, {
          id: entity.id,
          lang: entity.lang,
        })
      );
  ...
  return (
    <Container>
      <h1>Generate UML from Wikidata Schema</h1>
...
export default WikidataSchemaUML;
