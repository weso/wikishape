export const SchemaEntities = [
  {
    ...
    labels: {
      it: {
        lang: "it",
        label: "ShExR",
        descr: "schema per ShEx",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "ShExR",
        descr: "Basis schema voor een vorm expression",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "Wikimedia",
        descr: "schema per i progetti Wikimedia",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "Nota/Citazione/Fonte",
        descr: "schema per una nota/citazione/fonte",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "RDF (esterna)",
        descr: "schema per una nota/citazione/fonte (esterna)",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "Schema linking wikibase and wikidata",
        aliases: "",
      },
      hu: {
        lang: "hu",
  ...
  },
  {
    ...
    labels: {
      ...
      nl: {
        lang: "nl",
        label: "mens",
        descr: "simpel schema voor mensen",
        aliases: "persoon",
      },
      ko: {
        lang: "ko",
      ...
      en: {
        lang: "en",
        label: "human",
        descr: "simple schema for humans",
      ...
      es: {
        lang: "es",
        label: "ser humano",
        descr: "esquema simple para una persona",
        aliases: "persona",
      },
      ja: {
        lang: "ja",
      ...
      pt: {
        lang: "pt",
        label: "humano",
        descr: "esquema simples para humanos",
        aliases: "",
      },
      cs: {
        lang: "cs",
      ...
      gl: {
        lang: "gl",
        label: "ser humano",
        descr: "esquema simple para definir unha persoa",
        aliases: "persoa",
      },
      sr: {
        lang: "sr",
      ...
      eo: {
        lang: "eo",
        label: "homo",
        descr: "simpla skemo por homoj",
        aliases: "persono",
      },
      et: {
        lang: "et",
        label: "inimene",
        descr: "lihtne skeem inimese jaoks",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "festival cinematografico",
        descr: "schema per descrivere un festival cinematografico",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "filmfestival",
        descr: "Schema voor een filmfestival",
        aliases: "",
      },
      en: {
        lang: "en",
        label: "film festival",
        descr: "scheme for film festivals",
        aliases: "",
      },
      es: {
        lang: "es",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "edizione festival cinematografico",
        descr:
          "schema per descrivere un'edizione di un festival cinematografico",
        aliases: "",
      },
      da: {
        lang: "da",
        label: "filmfestivalsudgave",
        descr: "udgave af filmfestival",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      fr: {
        lang: "fr",
        label: "nombre naturel",
        descr: "",
        aliases: "",
      },
      it: {
        lang: "it",
        label: "numero naturale",
        descr: "schema per descrivere un numero naturale",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "natuurlijk getal",
        descr: "schema voor een natuurlijk getal",
        aliases: "",
      },
      eo: {
        lang: "eo",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "software",
        descr: "schema per descrivere un software",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        label: "serie TV",
        descr:
          "schema per descrivere una serie televisiva (proprietà base, senza identificatori)",
        aliases: "serie televisiva",
      },
      en: {
        lang: "en",
        label: "television series",
        descr: "basic scheme for television series, without identifiers",
        aliases: "",
      },
      es: {
        lang: "es",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        descr:
          "schema per descrivere una stagione di una serie televisiva (proprietà base, senza identificatori)",
      ...
      ja: {
        ...
        label: "テレビシリーズのシーズン",
        descr:
          "テレビシリーズのシーズンを記述するための基本的なスキーマ、識別子は含まず",
        aliases: "",
      },
      hu: {
        lang: "hu",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        descr:
          "schema per descrivere un episodio di una serie televisiva (proprietà base, senza identificatori)",
      ...
      en: {
        ...
        descr:
          "basic scheme for television series episode, without identifiers",
        aliases: "",
      },
      ja: {
        lang: "ja",
        label: "テレビシリーズのエピソード",
        descr:
          "テレビシリーズのエピソードを記述するための基本的なスキーマ、識別子は含まず",
        aliases: "",
      },
      hu: {
        lang: "hu",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "EastEnders",
        descr: "full scheme for TV series",
        aliases: "",
      },
      fr: {
        lang: "fr",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "canottiere/canottiera",
        descr: "schema per descrivere un/una canottiere/a",
        aliases: "",
      },
      nl: {
        lang: "nl",
      ...
      en: {
        ...
        label: "rower",
        descr:
          "schema for items about rowers, defined by P106: Q13382576 or subclass thereof",
      ...
      de: {
        ...
        label: "Ruderer",
        descr:
          "Schema für Objekte über Ruderer, definiert über P106: Q13382576 oder eine Unterklasse davon",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "sceneggiatore/sceneggiatrice",
        descr: "schema per descrivere uno/una sceneggiatore/sceneggiatrice",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "produttore/produttrice cinematografico/a",
        descr:
          "schema per descrivere un/una produttore/produttrice cinematografico/a",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "regista",
        descr: "schema per descrivere un/una regista",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        descr: "schema per descrivere un/una attore/attrice",
        aliases: "",
      },
      nl: {
        lang: "nl",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "lampadina",
        descr: "schema per descrivere una lampadina",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        descr:
          "schema per descrivere un/una direttore/direttrice della fotografia",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "basic scheme for camera operators",
  ...
  },
  {
    ...
    labels: {
      fr: {
        lang: "fr",
        label: "parc national australien",
        descr: "",
        aliases: "",
      },
      pt: {
      ...
      it: {
        lang: "it",
        label: "parco nazionale australiano",
        descr: "schema per descrivere un parco nazionale dell'Australia",
        aliases: "",
      },
      da: {
        lang: "da",
        label: "autralsk nationalpark",
        descr: "",
        aliases: "",
      },
      en: {
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        ...
        label: "formato file",
        descr:
          "schema per descrivere un formato o una famiglia di formati di file",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "Stato",
        descr: "schema per descrivere uno Stato",
        aliases: "",
      },
      ko: {
        lang: "ko",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Kakapo",
        descr: "Schema for Items about Kakapos",
        aliases: "",
      },
      fr: {
        lang: "fr",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "sostantivo (danese)",
        descr: "schema per descrivere un sostantivo in lingua danese",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "Deens zelfstandig naamwoord",
        descr: "",
        aliases: "",
      },
      eo: {
        lang: "eo",
        label: "dana substantivo",
        descr: "",
        aliases: "",
      },
      da: {
        lang: "da",
        label: "dansk navneord",
        descr: "",
        aliases: "",
      },
      en: {
  ...
  },
  {
    ...
    labels: {
      fr: {
        ...
        label: "œuvre écrite",
        descr:
          "concept d'une œuvre écrite et ses relations avec ses manifestations comme éditions",
      ...
      it: {
        ...
        label: "opera scritta",
        descr:
          "schema per descrivere un'opera scritta (e le sue relazioni con le edizioni e manifestazioni)",
      ...
      en: {
        ...
        label: "written work",
        descr:
          "abstract concept of a written work and its relations with its manifestations as editions",
        aliases: "book",
      },
      ja: {
        lang: "ja",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "edizione di un'opera scritta",
        descr: "schema per descrivere un'edizione di un'opera scritta",
        aliases: "",
      },
      sv: {
        lang: "sv",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "gene umano",
        descr: "schema per descrivere un gene umano",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "menselijk gen",
        descr:
          "basis schema voor een menselijk gen in Wikidata volgens gene wiki",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "proteina umana",
        descr: "schema per descrivere una proteina umana",
        aliases: "",
      },
      eo: {
        lang: "eo",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema of a reactome pathway in wikidata",
        aliases: "",
      },
      fr: {
        lang: "fr",
      ...
      it: {
        ...
        descr:
          "schema per descrivere un percorso biologico (con identificatore Reactome)",
        aliases: "",
      },
      ja: {
        lang: "ja",
  ...
  },
  {
    ...
    labels: {
      ...
      pt: {
        lang: "pt",
        label: "estrada europeia",
        descr: "",
        aliases: "",
      },
      it: {
        lang: "it",
        label: "strada europea",
        descr: "schema per descrivere una strada europea",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "Europese weg",
        descr: "basis schema voor Europese wegen",
        aliases: "",
      },
      en: {
        lang: "en",
  ...
  },
  {
    ...
    title:
      "biological pathway sourced from WikiPathways in Wikidata (E41) - Wikidata",
    labels: {
      en: {
        lang: "en",
        label: "biological pathway sourced from WikiPathways in Wikidata",
        descr:
          "schema for a biological pathway from wikipathways.org in Wikidata",
        aliases: "",
      },
      it: {
        lang: "it",
        ...
        descr:
          "schema per descrivere un percorso biologico (con identificatore WikiPathways)",
        aliases: "",
      },
      ja: {
        lang: "ja",
        ...
        descr:
          "WikidataにおけるWikiPathwaysから得られる生体パスウェイを記述するためのスキーマ",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "professore/professoressa universitario/a",
        descr:
          "schema per descrivere un/una professore/professoressa universitario/a",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      en: {
        ...
        label: "university",
        descr:
          "schema for a university based on the basic metadata listed at https://www.wikidata.org/wiki/Wikidata:WikiProject_Universities/Recommended_statements",
        aliases: "",
      },
      ja: {
        lang: "ja",
        label: "大学",
        descr:
          "次のWikiProjectに列挙されている大学メタデータを記述するためのスキーマ https://www.wikidata.org/wiki/Wikidata:WikiProject_Universities/Recommended_statements",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      ...
      it: {
        lang: "it",
        label: "elemento chimico",
        descr: "schema per descrivere un elemento chimico",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "scheikundig element",
        descr: "",
        aliases: "chemisch element",
      },
      eo: {
        lang: "eo",
      ...
      en: {
        ...
        descr:
          "Concept from chemistry allowing properties of atoms to be consistently described",
        aliases: "",
      },
      ja: {
        lang: "ja",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Wikidata prefixes",
        descr: "default prefixes",
        aliases: "",
      },
      it: {
        lang: "it",
  ...
  },
  {
    ...
    labels: {
      ...
      ja: {
        ...
        label: "スペインでの名前",
        descr:
          "スペインで多くつけられている名前を記述するための基本的なスキーマ",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      ...
      nl: {
        lang: "nl",
        label: "Deens werkwoord",
        descr: "basisschema voor een Deens werkwoord",
        aliases: "",
      },
      eo: {
        lang: "eo",
      ...
      da: {
        lang: "da",
        label: "dansk udsagnsord",
        descr: "",
        aliases: "dansk verbum | danske verber",
      },
      en: {
        lang: "en",
        label: "Danish verb",
  ...
  },
  {
    ...
    labels: {
      ...
      ja: {
        ...
        descr:
          "証拠と結論に関するオントロジー（ECO）の語を記述するためのスキーマ",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Danish pronouns",
        descr: "schema for Danish pronouns",
        aliases: "",
      },
      da: {
        lang: "da",
  ...
  },
  {
    ...
    labels: {
      ...
      nl: {
        lang: "nl",
        label: "deens telwoord",
        descr: "basis schema voor een Deens telwoord",
        aliases: "",
      },
      ru: {
        lang: "ru",
  ...
  },
  {
    ...
    labels: {
      ...
      ja: {
        ...
        label: "モーツァルト作の楽曲",
        descr:
          "ヴォルフガング・アマデウス・モーツァルト作の楽曲を記述するための基本的なスキーマ",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      ...
      en: {
        ...
        label: "disease",
        descr:
          "basic schema for a human disease according to the disease ontology",
        aliases: "",
      },
      ja: {
        lang: "ja",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr:
          "basic schema for items sourced from clinical interpretations in variants in cancer",
  ...
  },
  {
    ...
    labels: {
      ...
      nl: {
        lang: "nl",
        label: "Deens bijvoeglijk naamwoord",
        descr: "",
        aliases: "",
      },
      eo: {
        lang: "eo",
        label: "dana adjektivo",
        descr: "",
        aliases: "",
      },
      da: {
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Western Lombard language common taxon names",
        descr: "schema of a vernacular name on Wikidata",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "file format with PRONOM id",
        descr: "schema for a file format item that has a PUID identifier",
        aliases: "file format with PUID",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "volcano",
        descr: "General schema for volcanos on Wikidata",
        aliases: "vulcano",
      },
      eo: {
        lang: "eo",
      ...
      nl: {
        lang: "nl",
        label: "vulkaan",
        descr: "schema voor een vulkaan geregistreerd in Wikidata",
        aliases: "",
      },
      pt: {
        lang: "pt",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "lighthouse",
        descr: "Schema for lighthouse on Wikidata",
        aliases: "",
      },
      nl: {
        lang: "nl",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "basic schema for cryptocurrencies",
        aliases: "",
      },
      pt: {
        lang: "pt",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "basic schema for W3C Recommendation",
        aliases: "W3C REC",
      },
    },
  },
  {
    ...
    title:
      "Scores for a discipline in a figure skating competition (E84) - Wikidata",
    labels: {
      en: {
        lang: "en",
        label: "Scores for a discipline in a figure skating competition",
        descr: "",
        aliases: "",
      },
      fr: {
        lang: "fr",
        label:
          "Scores d'une discipline dans une compétition de patinage artistique",
        descr: "",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "general schema for a academic conference in Wikidata",
        aliases: "",
      },
      da: {
        lang: "da",
        label: "videnskabelig konference",
        descr: "",
        aliases: "",
      },
      de: {
        lang: "de",
        label: "wissenschaftliche Konferenz",
        descr: "",
        aliases: "",
      },
      pt: {
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "native Wikipathways schema",
        descr:
          "basic schema of a Pathway in Wikipathways as expressed on http://www.wikipathways.org",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "biological pathway in Wikidata",
        descr: "basic schema of biological pathways in Wikidata",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "health in region",
        descr: "basic scheme for health by region/country items",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Public library branch in The Netherlands",
        descr:
          "Schema for a public library branch (except library buses) in The Netherlands",
        aliases: "",
      },
      de: {
        lang: "de",
        ...
        descr:
          "Schema für eine öffentliche Bibliotheksfiliale (außer Bibliotheksbusse) in den Niederlanden",
      ...
      nl: {
        lang: "nl",
        label: "Openbare bibliotheekvestiging in Nederland",
        descr:
          "Schema voor een openbare bibliotheekvestiging (m.u.v.bibliobussen) in Nederland",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Public library organisation in The Netherlands",
        descr: "Schema for a public library organisation in The Netherlands",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label: "Openbare bibliotheekorganisatie in Nederland",
        descr: "Schema voor een openbare bibliotheekorganisatie in Nederland",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Emulator",
        descr: "base schema for emulators",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Delftware pottery workshops",
        descr: "schema for Delftware pottery workshops",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "FLOSS emulator",
        descr: "schema for a free/libre/open source software emulator",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Newspaper clippings archives",
        descr: "Schema for instances of Q65651503",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Newspaper clippings archives (minimal)",
        descr: "Minimal schema for instances of Q65651503",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "dummy",
        descr: "for another variant of E94",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Instance of",
        descr: "Example schema for WikiProject:ShEx/How to get started?",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Instance of organization (or subclass)",
        descr: "for WikiProject: ShEx/How to get started?",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "statue",
        descr: "general schema for a statue",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "book edition in Libris",
        descr: "schema for editions in the Libris library catalog",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "base schema for operating systems",
        aliases: "os",
      },
      es: {
        lang: "es",
        label: "sistema operativo",
        descr: "esquema simple para un sistema operativo",
        aliases: "so",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "gene variant according to myvariant.info",
        descr:
          "schema of gene variant statements sourced through myvariant.info",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "deceased person in Dutch Wikipedia",
        descr:
          "general schema for a deceased person described in the Dutch Wikipedia",
        aliases: "",
      },
      nl: {
        lang: "nl",
        label:
          "Overleden persoon op de Nederlandstalige Wikipedia (bron bij overlijden)",
        descr:
          "generiek schema voor overleden personen op de Nederlandstalige Wikipedia (bron bij overlijden)",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Lunar crater",
        descr: "schema for lunar craters",
        aliases: "moon crater",
      },
      ast: {
        lang: "ast",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "chromosome",
        descr: "general schema describing items on chromosomes on Wikidata",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "general schema describing a sequence assembly",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr:
          "general schema for human chromosomes that builds on the general schema for chromosome (E107)",
        aliases: "",
      },
      ast: {
        lang: "ast",
        label: "cromosoma humanu",
        descr:
          "esquema xeneral pa cromosomes humanos que se forma dende l'esquema xeneral pa cromosoma (E107)",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for software license",
        aliases: "",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for virtual reality headsets",
        aliases: "VR headset",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Disease Ontology mapping",
        descr: "schema for items sourced from the Disease Ontology",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "trail",
        descr: "schema for trails",
        aliases: "hiking trail",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Tsunami",
        descr: "Extracted schema for Tsunami's on Wikidata",
        aliases: "",
      },
      ast: {
        lang: "ast",
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "newspaper with direct claim properties only",
        descr:
          "schema of a newspaper with direct claim properties only (i.e. wdt:~",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for virtual assistant software agents",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "space probe",
        descr: "schema for space probes",
        aliases: "",
      },
      ast: {
        lang: "ast",
        label: "sonda espacial",
        descr: "esquema pa sondes espaciales",
        aliases: "",
      },
      fr: {
        lang: "fr",
        label: "sonde spatiale",
        descr: "",
        aliases: "",
      },
    },
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr:
          "An EntitySchema to try things out, not intended for productive use",
        aliases: "test schema",
      },
      de: {
        lang: "de",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr:
          "Nobel Prize Winners which includes ALL the Prize types including Peace Prize",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for interstellar objects",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "extrasolar planet",
        descr: "schema for extrasolar planets",
        aliases: "exoplanet",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "one-of-a-kind computer",
        descr: "schema for one-of-a-kind computers",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "adminstrative district in Turkey",
        descr: "schema for administrative district in Turkey",
        aliases: "",
      },
      fr: {
        lang: "fr",
  ...
  },
  {
    ...
    labels: {
      ...
      de: {
        lang: "de",
        label: "Mitglied des schwedischen Parlaments",
        descr: "",
        aliases: "",
      },
      sv: {
        lang: "sv",
        label: "Riksdagsledamot 2018",
        descr: "medlem av svenska Riksdagen 2018",
        aliases: "",
      },
      en: {
        lang: "en",
        label: "Swedish Parliament member",
        descr: "member of the Swedish Parliament",
        aliases: "",
      },
      ast: {
        lang: "ast",
        label: "miembru del Parlamentu suecu",
        descr: "",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Languages should have an IETF language tag",
        descr: "",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Malayalam lexeme",
        descr: "entity schema for lexemes in Malayalam",
        aliases: "",
      },
      ast: {
        lang: "ast",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "this item has a privacy policy URL",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "competition class items",
        descr:
          "schema for items that can be used as values for Property:P2094 (competition class)",
        aliases: "",
      },
      de: {
        lang: "de",
        ...
        descr:
          "Schema für Objekte, die als Werte für die Eigenschaft Property:P2094 (Wettbewerbsklasse) genutzt werden können",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for metropolitan statistical areas",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for UNESCO world heritage site",
        aliases: "world heritage site",
      },
      nl: {
        lang: "nl",
        label: "UNESCO wereld erfgoed",
        descr: "",
        aliases: "",
      },
    },
  ...
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "submarine communications cable",
        descr: "schema for submarine communications cables",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Nazca lines",
        descr: "schema for geoglyphs that make up the Nazca lines",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        ...
        descr: "schema for cryptographic hash function",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "Specific event in figure skating",
        descr: "Schema to check for specific figure skating events",
        aliases: "",
      },
      fr: {
        lang: "fr",
        ...
        descr:
          "schema pour vérifier des évènements spécifiques en patinage artistique",
        aliases: "",
      },
    },
  },
  {
    ...
    labels: {
      en: {
        lang: "en",
        label: "watercraft",
        descr: "All types of vessels",
        aliases: "watercraft | vessel | ship | boat",
      },
      nl: {
        lang: "nl",
        label: "watervoertuig",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        label: "virus protein",
        descr:
          "schema that adds to the generic protein schema (E167) to apply on virus protein shapes",
        aliases: "",
      },
      de: {
        lang: "de",
        label: "Virus-Protein",
        descr:
          "Entity-Schema für ein Virus-Protein, aufbauend auf dem Schema E167 für Proteine allgemein",
        aliases: "",
      },
      es: {
        lang: "es",
        ...
        descr:
          "Esquema que añade al esquema genérico de proteína (E167) las propiedades específicas de la proteína de virus",
        aliases: "",
      },
      "pt-BR": {
        lang: "pt-BR",
  ...
  },
  {
    ...
    title:
      "lockdown part of the 2019-2020 coronavirus disease pandemic (E191) - Wikidata",
    labels: {
      en: {
        lang: "en",
        label: "lockdown part of the 2019-2020 coronavirus disease pandemic",
        descr:
          "lockdown part of quarantine for the 2019-2020 coronavirus disease pandemic",
        aliases: "",
      },
      es: {
        lang: "es",
        label:
          "toque de queda parte de la pandemia de enfermedad por coronavirus de 2019-2020",
        descr: "",
        aliases: "",
      },
      fi: {
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        label: "Filmmaker",
        descr:
          "schema for a filmmaker whose work is held in a film archive or other insitutional collection",
  ...
  },
  {
    ...
    labels: {
      en: {
        ...
        descr:
          "Entity schema of COVID-19 dashboards, search engines and datasets",
        aliases: "",
      },
    },
  },
  ...
  },
  {
    ...
    title:
      "member of the Instituto Universitario de Análisis y Aplicaciones Textuales (E220) - Wikidata",
    labels: {
      en: {
        lang: "en",
        label:
          "member of the Instituto Universitario de Análisis y Aplicaciones Textuales",
        descr: "",
        aliases: "",
      },
      es: {
        lang: "es",
        label:
          "miembro del Instituto Universitario de Análisis y Aplicaciones Textuales",
